...
extension SCNPhysicsContact {
    ...
    func checkCollisionBetween1<NodeTypeA: SCNNode, NodeTypeB: SCNNode>(nodeTypeA: NodeTypeA.Type, nodeTypeB: NodeTypeB.Type) -> (nodeOfTypeA: NodeTypeA, nodeOfTypeB: NodeTypeB)? {
